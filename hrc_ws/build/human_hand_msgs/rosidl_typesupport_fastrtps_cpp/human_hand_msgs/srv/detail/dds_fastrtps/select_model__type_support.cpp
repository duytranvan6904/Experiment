...
#include "human_hand_msgs/srv/detail/select_model__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = human_hand_msgs::srv::SelectModel_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const human_hand_msgs::srv::SelectModel_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<human_hand_msgs::srv::SelectModel_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SelectModel_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const human_hand_msgs::srv::SelectModel_Request *>(
...
static size_t _SelectModel_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SelectModel_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SelectModel_Request__callbacks = {
  "human_hand_msgs::srv",
  "SelectModel_Request",
...
static rosidl_message_type_support_t _SelectModel_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SelectModel_Request__callbacks,
...
get_message_type_support_handle<human_hand_msgs::srv::SelectModel_Request>()
{
  return &human_hand_msgs::srv::typesupport_fastrtps_cpp::_SelectModel_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = human_hand_msgs::srv::SelectModel_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const human_hand_msgs::srv::SelectModel_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<human_hand_msgs::srv::SelectModel_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SelectModel_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const human_hand_msgs::srv::SelectModel_Response *>(
...
static size_t _SelectModel_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SelectModel_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SelectModel_Response__callbacks = {
  "human_hand_msgs::srv",
...
static rosidl_message_type_support_t _SelectModel_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SelectModel_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_human_hand_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<human_hand_msgs::srv::SelectModel_Response>()
{
  return &human_hand_msgs::srv::typesupport_fastrtps_cpp::_SelectModel_Response__handle;
}
...
static service_type_support_callbacks_t _SelectModel__callbacks = {
  "human_hand_msgs::srv",
  "SelectModel",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, human_hand_msgs, srv, SelectModel_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, human_hand_msgs, srv, SelectModel_Response)(),
...
static rosidl_service_type_support_t _SelectModel__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SelectModel__callbacks,
...
get_service_type_support_handle<human_hand_msgs::srv::SelectModel>()
{
  return &human_hand_msgs::srv::typesupport_fastrtps_cpp::_SelectModel__handle;
}
