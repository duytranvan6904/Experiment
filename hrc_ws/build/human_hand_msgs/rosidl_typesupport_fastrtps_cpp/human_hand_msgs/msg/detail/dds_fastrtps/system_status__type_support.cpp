...
#include "human_hand_msgs/msg/detail/system_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const human_hand_msgs::msg::SystemStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  human_hand_msgs::msg::SystemStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = human_hand_msgs::msg::SystemStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const human_hand_msgs::msg::SystemStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<human_hand_msgs::msg::SystemStatus *>(
    untyped_ros_message);
...
get_message_type_support_handle<human_hand_msgs::msg::SystemStatus>()
{
  return &human_hand_msgs::msg::typesupport_fastrtps_cpp::_SystemStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, human_hand_msgs, msg, SystemStatus)() {
  return &human_hand_msgs::msg::typesupport_fastrtps_cpp::_SystemStatus__handle;
}
